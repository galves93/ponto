        ...
        Column(
          ...
          children: <Widget>[
            Container(
                  ...
                  child: TableCalendar(
                    ...
                    calendarStyle: CalendarStyle(
                      ...
                      weekendStyle: TextStyle()
                          .copyWith(color: Colors.orange), //blue[800]),
                    ),
                    daysOfWeekStyle: DaysOfWeekStyle(
                      weekdayStyle: TextStyle().copyWith(color: Colors.white),
                      weekendStyle: TextStyle()
                          .copyWith(color: Colors.orange), //blue[600]),
                    ),
                ...
                color: canvasColor),
            Container(child: SizedBox(height: 8.0), color: canvasColor),
            Container(child: SizedBox(height: 8.0), color: canvasColor),
            Expanded(
